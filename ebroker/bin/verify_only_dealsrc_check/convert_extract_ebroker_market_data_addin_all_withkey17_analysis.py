...
#		if (abs(currPrices[currID]["accSize"]-currPrices[currID]["accSize2"])>2) {
#		}
		return outstr + "B," + bidOutStr + ",A," + askOutStr + "," + str(currPrices[currID]["accSize2"])
...
def updateAccSize2(currID, accSize):
	global currPrices
	currPrices[currID]["accSize2"] = accSize
...
#				updateInfo = updateInfo + "ask_queue %s " %(fields[i+1])
		if keyf == 17 and (genType == "BidAsk" or genType == "BidAskTrade" or genType == "BidAskTrade_DH_DL_PC_TO" or genType=="BidAskTradeOMS"):
			if (genType=="BidAskTradeOMS"):
				updateAccSize2(currID,fields[i+1])
			else:
				updateAccSize(currID,fields[i+1])
			if (genType == "BidAskTrade" or genType == "BidAskTrade_DH_DL_PC_TO" or genType=="BidAskTradeOMS"):
